...
const AppointmentScreen = () => {
  ...
  const [successSnackbarOpen, setSuccessSnackbarOpen] = useState(false); // State for success snackbar
  ...
  return (
    <>
      ...
      <Snackbar
        ...
        autoHideDuration={2000} // Duration to keep snackbar open (ms)
        onClose={handleSnackbarClose}
        message="Đặt lịch thành công!"
        sx={{ background: '#4caf50' }} // Green background color
      />
      <Footer />
    </>
  );
