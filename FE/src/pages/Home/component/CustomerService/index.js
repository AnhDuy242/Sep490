        ...
        <Box sx={{ flexGrow: 1, p: 3 }}>
            <Grid container spacing={3}>
                <ServiceButton
                    ...
                    description="Quý khách hàng sử dụng tiện ích này để đặt lịch lấy mẫu tại nhà hoặc đặt lịch khám chữa bệnh tại các cơ sở của MEDLATEC"
                ...
                <ServiceButton
                    ...
                    description="Quý khách hàng sử dụng tiện ích này để tra cứu kết quả sau khi sử dụng dịch vụ y tế tại Hệ thống Y tế MEDLATEC"
                    to={isLoggedIn ? "/getMedicalNotebook" : null}  // Adjust this route as needed
                />
                <ServiceButton
                    icon={<AttachMoneyIcon fontSize="large" color="primary" />}
                    title="Bảng giá dịch vụ"
                    description="Quý khách hàng sử dụng tiện ích này để tra cứu giá dịch vụ y tế tại Hệ thống Y tế MEDLATEC"
                    to="/price-list"  // Adjust this route as needed
                />
                <ServiceButton
                    icon={<HelpOutlineIcon fontSize="large" color="primary" />}
                    title="Hỏi đáp chuyên gia"
                    description="Quý khách hàng sử dụng tiện ích này để đặt câu hỏi và nhận hướng dẫn, giải đáp thắc mắc từ chuyên gia y tế của MEDLATEC"
                    onClick={isLoggedIn ? null : handleShowLogin}
