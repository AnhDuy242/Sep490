...
// import {Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, CircularProgress, IconButton, Typography, TextField, 
//   Button, Dialog, DialogActions, DialogContent, DialogTitle, Select, MenuItem, FormControl, InputLabel} from '@mui/material';
// import Autocomplete from '@mui/material/Autocomplete';
// import { loadDoctors, addDoctor } from '../../services/doctor_service';
...
const DoctorTable = () => {
  ...
  //   try {
  //     const updatedDoctor = await updateDoctor(currentDoctor.accId, currentDoctor);
