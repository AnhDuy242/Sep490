...
const breakPoints = [
    { width: 60, height: 500, itemsToShow: 1 }
];
        ...
        <>
            <div className="slider">
                <Carousel breakPoints={breakPoints}>
                    <Item>   <img src={img1} alt="Carousel Image 1" />
                    ...
                    <Item>  <img src={img2} alt="Carousel Image 2" /><div className="button-text-2">
                    <Link to="/****"  style={{ textDecoration: 'none' }}>  <button className="button-slider"><span>Đặt lịch ngay</span></button>  </Link>
                    <Link to="/****"  style={{ textDecoration: 'none' }}>   <button className="button-slider"><span>Chat trực tiếp</span></button> </Link>
                    </div></Item>
                    <Item><img src={img3} alt="Carousel Image 3" /><div className="button-text-3">
                     <Link to="/****"  style={{ textDecoration: 'none' }}>  <button className="button-slider"><span>Đặt lịch ngay</span></button>  </Link>
                     <Link to="/****"  style={{ textDecoration: 'none' }}>   <button className="button-slider"><span>Chat trực tiếp</span></button> </Link>
                    </div></Item>
